import { CheckCircle2, ShieldCheck, Truck, Flame } from 'lucide-react';
...
export default function Advantages() {
  ...
  const advs = [
    ...
    { icon: <Flame size={40} />, title: t('home.advantages.promotions'), desc: t('home.advantages.promotionsDesc') }
  ];
