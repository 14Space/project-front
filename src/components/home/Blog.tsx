    ...
    <section className="section" style={{ backgroundColor: 'var(--bg-color)' }}>
      <div className="container">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
           <h2 className="title" style={{ margin: 0 }}>Блог и новости</h2>
           <a href="#" style={{ color: '#A6CE39', fontWeight: 600 }}>Все статьи →</a>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
          {posts.map((post, idx) => (
            <div key={idx} style={{ borderRadius: '8px', overflow: 'hidden', border: '1px solid #e5e5e5', cursor: 'pointer' }}>
